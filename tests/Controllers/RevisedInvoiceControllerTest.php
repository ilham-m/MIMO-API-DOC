...
class RevisedInvoiceControllerTest extends TestCase
{
    /**
     * @var \TESTAREAAPISERVICELib\Controllers\RevisedInvoiceController Controller instance
     */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$controller = ClientFactory::create(self::$httpResponse)->getRevisedInvoiceController();
    }
 ...
 ' .
  ...
  ' .
      ...
      "total": 35000
            ...
            'TESTAREAAPISERVICELib\Models\\StoreInvoiceRequest2'
        );
  ...
  "invoice": [
    ...
    public function testSingleEditInvoice()
    {
        ...
        $result = null;
        try {
            $result = self::$controller->singleEditInvoice($accept, $description, $carton, $cbm, $pricePerCbm);
        } catch (ApiException $e) {
        }
