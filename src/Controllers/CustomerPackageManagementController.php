...
class CustomerPackageManagementController extends BaseController
{
     ...
     */
    public function getCustomerPackageInvoicePdf(string $accept)
    {
        //prepare query string for API call
        $_queryBuilder = '/customer-package/invoice/MIMO-000001';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function getCustomerPackagePackageListPdf(string $accept)
    {
        //prepare query string for API call
        $_queryBuilder = '/customer-package/package-list/MIMO-000001';
